 ...
 * something worse.
 * @param {{reportId: string, userId: string, organizationId: string, templateId?: string|null, format: 'xlsx'|'pdf', fileSizeBytes?: number|null, status?: 'success'|'failed', errorMessage?: string|null, fileKey?: string|null}} entry
 */
