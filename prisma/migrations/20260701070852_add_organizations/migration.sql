...
-- AlterTable
ALTER TABLE "reports" ADD COLUMN     "organization_id" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "reports" ADD CONSTRAINT "reports_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
